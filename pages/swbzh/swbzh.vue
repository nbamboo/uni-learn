		...
		data() {
			return {
				listData: [{
					...
					{
						a: 2,
						b: "超过36000元至144000元的部分",
						c: 10,
					},
					{
						a: 3,
						b: "超过144000元至300000元的部分",
						c: 20,
					},
					{
						a: 4,
						b: "超过300000元至420000元的部分",
						c: 25,
					},
					{
						a: 5,
						b: "超过420000元至660000元的部分",
						c: 30,
					},
					{
						a: 6,
						b: "超过660000元至960000元的部分",
						c: 35,
					},
					{
						a: 7,
...
<style>
	...
	.table__row__td:nth-child(2) .table__row__text {
		display: inline;
		padding-left: 20%;
	}
</style>